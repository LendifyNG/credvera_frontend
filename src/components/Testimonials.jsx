...
export default function Testimonials() {
  ...
  const testimonialText = "“When I signed up with Lendwise it was a no-brainer. It's been one of the best decisions I've made to ensure my finances are on point”.";

  // Base cards mapping to the distinct faces in the dual-track screenshot
  const baseCardsRow1 = [
    { id: 1, name: "Alex Bergwijn", role: "Accounting at Mailchimp", avatar: "https://i.pravatar.cc/150?u=a042581f4e29026704b" }, // Black man
    { id: 2, name: "Alex Bergwijn", role: "Accounting at Mailchimp", avatar: "https://i.pravatar.cc/150?u=a042581f4e29026704c" }, // White man
    { id: 3, name: "Alex Bergwijn", role: "Accounting at Mailchimp", avatar: "https://i.pravatar.cc/150?u=a042581f4e29026704d" }, // White woman red hair
    { id: 4, name: "Alex Bergwijn", role: "Accounting at Mailchimp", avatar: "https://i.pravatar.cc/150?u=a042581f4e29026704e" }, // Extra
    { id: 5, name: "Alex Bergwijn", role: "Accounting at Mailchimp", avatar: "https://i.pravatar.cc/150?u=a042581f4e29026704f" }, // Extra
  ];

  const baseCardsRow2 = [
    { id: 6, name: "Alex Bergwijn", role: "Accounting at Mailchimp", avatar: "https://i.pravatar.cc/150?u=a042581f4e29026704d" },
    { id: 7, name: "Alex Bergwijn", role: "Accounting at Mailchimp", avatar: "https://i.pravatar.cc/150?u=a042581f4e29026704b" },
    { id: 8, name: "Alex Bergwijn", role: "Accounting at Mailchimp", avatar: "https://i.pravatar.cc/150?u=a042581f4e29026704c" },
    { id: 9, name: "Alex Bergwijn", role: "Accounting at Mailchimp", avatar: "https://i.pravatar.cc/150?u=a042581f4e29026704e" },
    { id: 10, name: "Alex Bergwijn", role: "Accounting at Mailchimp", avatar: "https://i.pravatar.cc/150?u=a042581f4e29026704f" },
  ];
  ...
  return (
    <section id="testimonials" className="bg-white relative overflow-hidden font-sans border-t border-black/5">
      ...
      <div className="w-full relative z-10 py-16 lg:py-24 flex flex-col items-start overflow-hidden">
        ...
        >
          <motion.span variants={itemVariants} className="text-gray-400 font-semibold text-[15px] mb-4">
            Testimonial
          </motion.span>
          <motion.h2 variants={itemVariants} className="text-[2.6rem] lg:text-[4rem] font-bold text-[#0c0c0c] leading-[1.05] tracking-tight whitespace-nowrap">
            What Customer Says
          </motion.h2>
        </motion.div>
              ...
              >
                ...
                <div className="flex items-center gap-4 mt-auto">
                  ...
                  <div className="flex flex-col">
                    <span className="font-bold text-[#0c0c0c] text-[0.95rem] tracking-tight">{card.name}</span>
                    <span className="text-gray-400 text-[0.85rem] font-medium">{card.role}</span>
                  </div>
                </div>
              </div>
            ))}
