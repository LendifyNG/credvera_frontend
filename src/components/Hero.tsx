        ...
        <div className="flex flex-col lg:flex-row items-center justify-between w-full h-full grow gap-16 lg:gap-10">
          ...
          >
            <motion.h1
              ...
              className="text-white text-4xl md:text-5xl lg:text-6xl font-semibold leading-[1.1] tracking-tight mb-6 w-full max-w-[90%]"
            >
            ...
            <motion.p
              variants={textVariants}
              className="text-white/80 text-base md:text-lg leading-[1.6] max-w-100 mb-10 font-medium"
            >
              Join millions of businesses trusting Credvera to manage payments
              and finances across Africa and outside.
            </motion.p>
          ...
          <motion.div
            className="w-full lg:w-[59%] flex justify-end"
          ...
          >
            <img
              ...
              className="w-full h-auto max-w-180 object-contain drop-shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
              loading="eager"
            />
          </motion.div>
        </div>
